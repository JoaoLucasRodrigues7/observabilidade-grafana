...
const spans: Span[] = [
  ...
  { name: 'auth.verify', service: 'auth-svc', start: 12, dur: 48, depth: 1, color: '#7b61ff' },
  { name: 'cart.load', service: 'cart-svc', start: 64, dur: 70, depth: 1, color: '#00b3a4' },
  { name: 'SELECT cart_items', service: 'postgres', start: 78, dur: 44, depth: 2, color: '#3b82f6' },
  { name: 'payment.charge', service: 'payment-svc', start: 140, dur: 150, depth: 1, color: '#e0b400' },
  { name: 'POST stripe.api', service: 'external', start: 152, dur: 120, depth: 2, color: '#ec4899' },
  { name: 'order.persist', service: 'order-svc', start: 294, dur: 24, depth: 1, color: '#22c55e' },
]
